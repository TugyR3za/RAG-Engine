...
{
    VulkanFrameResources::VulkanFrameResources(VkDevice device, u32 graphics_queue_family, u32 frames_in_flight)
        : device_(device)
    {
        ...
        for (VulkanFrameData& frame : frames_)
        {
            ...
            RAG_VK_CHECK(vkCreateSemaphore(device_, &semaphore_create_info, nullptr, &frame.render_finished));
