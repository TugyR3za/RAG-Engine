...
namespace rag::renderer::vk
{
    struct ObjMeshData
    {
        ...
        // True when every face corner carried a texture-coordinate index;
        // otherwise missing UVs were generated from spherical projection.
        bool texcoords_from_file = false;
    };
    ...
    // carries no color), missing UVs use spherical projection, and repeated
    // position/normal/UV combinations are deduplicated.
